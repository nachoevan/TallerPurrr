...
\definecolor{greenstring}{HTML}{4C946A}
\definecolor{redcomment}{HTML}{B15963}
\definecolor{bluehighlight}{HTML}{2E85EF}
...
\lstdefinestyle{codechunk}{
	...
	alsoletter = {_,\.,\%,>,\~,},
  keywords={map,map_chr,map_dbl,map_int,map2,map2_chr,pmap,possibly},
  morestring=[b][\color{greenstring}]",
  morecomment=[l][\color{redcomment}]\#,
	showstringspaces=false,
	sensitive=false,
	basicstyle=\footnotesize\ttfamily,
	style=FiraCodeStyle,
	keywordstyle=\bfseries\color{bluehighlight},
	keywordstyle={[2]\color{red}},
	keywords=[2]{TRUE,FALSE,NA}}
%	keywordstyle = {[3]\color{orange}}
%	keywords=[3]{{.x},\%>\%,\~, \~, \~ , \~\ ,,\.x,{\.y}, \.y, \.x,\.\.1,\.\.2,\.\.3}}
